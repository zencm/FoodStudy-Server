            ...
            <div class="login-container">
                ...
                <form action="{{ route('voyager.login') }}" method="POST">
                    ...
                    <div class="form-group form-group-default" id="usernameGroup">
                        <label>Login</label>
                        <div class="controls">
                            <input type="text" name="username" id="username" value="{{ old('username') }}" placeholder="Username (not email)" class="form-control" required>
                         </div>
                    </div>
...
<script>
    ...
    // Focus events for username and password fields
